 ...
 */
  ...
  rootFailureProtocol(forced = false){
    this.onSuddenClose()
    this.close()
    /*
    let chat = this;
...
// -Add cyphering.
mainEvents.on('main:setupUser', ( params) => {
  setupUser(params.username,params.password,PEERJS_OPTIONS);
});
function setupUser(username,password,PEERJS_OPTIONS){
  me.username=username;
  me.password=password;

  [me.prKey,me.puKey]=generateKeys(username+password);
  //console.log(me)
  //let a = sign("hello",  me.prKey, username, password)//, me.username,me.password)
  //let b = verify(a,"hello", me.puKey);
  //console.log(b)
  me.PEERJS_OPTIONS=PEERJS_OPTIONS;
...
function userCreate(){
  ...
  var settings = {};
  myID=username;
  mainEvents.emit('main:setupUser', {
